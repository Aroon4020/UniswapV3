...
contract UniswapV3Pool {
    ...
    function mint(
        ...
        int24 upperTick,
        uint128 amount,
        bytes calldata data ///encoded data of callbackdata of struct
        ...
        /// change in pool liquidity as a result position update
        ...
        // update liquidity of the pool based on amount being added
    ...
    function swap(address recipient, bytes calldata data) public returns (int256 amount0, int256 amount1) {
        // hardcoded target price & tick to keep things simple
        int24 nextTick = 85184;
        uint160 nextPrice = 5604469350942327889444743441197;

        amount0 = -0.008396714242162444 ether; /// to be transffered to recipient (swap out)
        amount1 = 42 ether; /// swap in

        //update next tick position & next price
